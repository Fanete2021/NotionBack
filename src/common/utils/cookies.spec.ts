...
describe('getCookieValue', () => {
  it('should return undefined if headers are missing', () => {
    ...
    expect(getCookieValue(req, 'testCookie')).toBeUndefined();
  });
  ...
  it('should return the correct cookie value when it exists', () => {
    ...
    expect(getCookieValue(req, 'testCookie')).toBe('value123');
  });
  ...
  it('should decode URI encoded cookie values', () => {
    ...
    expect(getCookieValue(req, 'testCookie')).toBe('hello world');
  });
